...
{\Large $\underline{10_{35}~(K10a_{23})}$}
...
\multirow{5}{120pt}{
	\centering
	\includegraphics[width=112pt]{../../../GIT/diagram.site/Diagrams/png/119_10_35.png}\\
...
\begin{tikzpicture}[x=20pt, y=17pt]
	...
	(C1U) edge (C1D) (C2D) edge (C2U) (C3U) edge (C3D) (C4D) edge (C4U) (C5D) edge (C5U) (C6U) edge (C6D) (C7D) edge (C7U) (C8D) edge (C8U) (C9D) edge (C9U) (C10U) edge (C10D) ;
	\end{tikzpicture} \\
\hhline{~~} \\& 
...
\centering \section*{I. $I^u_{1}= \langle u^{24}+u^{23}+\cdots+2 u+1 \rangle$}
