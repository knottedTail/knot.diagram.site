...
\multirow{5}{120pt}{
	\centering
	\includegraphics[width=112pt]{../../../GIT/diagram.site/Diagrams/png/36_9_1.png}\\
...
\centering \section*{I. $I^u_{1}= \langle u^3-3 u-1 \rangle$}
...
\flushright $a_{4}=$&$\begin{pmatrix}- u-1\\-2 u-1\end{pmatrix}$ \\
\flushright $a_{8}=$&$\begin{pmatrix}u+1\\u^2+u\end{pmatrix}$\\ \flushright $a_{8}=$&$\begin{pmatrix}u+1\\u^2+u\end{pmatrix}$\\&\end{tabular}
...
\text{Solutions to }I^u_{1}& \I (\text{vol} + \sqrt{-1}CS) & \text{Cusp shape}\\
 \hline 
\begin{aligned}
u &= -1.53209\phantom{ +0.000000I}\end{aligned}
 & -13.7078\phantom{ +0.000000I} & -18.0000\phantom{ +0.000000I} \\ \hline\begin{aligned}
u &= -0.347296\phantom{ +0.000000I}\end{aligned}
 & -0.548311\phantom{ +0.000000I} & -18.0000\phantom{ +0.000000I} \\ \hline\begin{aligned}
u &= \phantom{-}1.87939\phantom{ +0.000000I}\end{aligned}
 & \phantom{-}12.6112\phantom{ +0.000000I} & -18.0000\phantom{ +0.000000I}\\
 \hline 
 \end{array}$$\newpage\newpage\renewcommand{\arraystretch}{1}
