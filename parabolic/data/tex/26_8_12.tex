...
\multirow{5}{120pt}{
	\centering
	\includegraphics[width=112pt]{../../../GIT/diagram.site/Diagrams/png/26_8_12.png}\\
...
\begin{tikzpicture}[x=20pt, y=17pt]
	...
	(C1D) edge (C1U) (C2U) edge (C2D) (C3U) edge (C3D) (C4D) edge (C4U) (C5U) edge (C5D) (C6D) edge (C6U) (C7U) edge (C7D) (C8D) edge (C8U) ;
	\end{tikzpicture} \\
\hhline{~~} \\& 
...
\begin{align*}
I^u_{1}&=\langle 
u^{14}- u^{13}+3 u^{12}-2 u^{11}+6 u^{10}-3 u^9+7 u^8-2 u^7+6 u^6+4 u^4+2 u^2+u+1\rangle \\
\\
\end{align*}
...
\centering \section*{I. $I^u_{1}= \langle u^{14}- u^{13}+3 u^{12}-2 u^{11}+6 u^{10}-3 u^9+7 u^8-2 u^7+6 u^6+4 u^4+2 u^2+u+1 \rangle$}
