...
\multirow{5}{120pt}{
	\centering
	\includegraphics[width=112pt]{../../../GIT/diagram.site/Diagrams/png/22_8_8.png}\\
...
\begin{align*}
I^u_{1}&=\langle 
u^{12}- u^{11}-3 u^{10}+4 u^9+3 u^8-6 u^7+2 u^6+2 u^5-4 u^4+3 u^3+u^2-2 u+1\rangle \\
\\
\end{align*}
...
\centering \section*{I. $I^u_{1}= \langle u^{12}- u^{11}-3 u^{10}+4 u^9+3 u^8-6 u^7+2 u^6+2 u^5-4 u^4+3 u^3+u^2-2 u+1 \rangle$}
