...
\multirow{5}{120pt}{
	\centering
	\includegraphics[width=112pt]{../../../GIT/diagram.site/Diagrams/png/27_8_13.png}\\
...
\begin{tikzpicture}[x=20pt, y=17pt]
	...
	(C1U) edge (C1D) (C2D) edge (C2U) (C3D) edge (C3U) (C4U) edge (C4D) (C5U) edge (C5D) (C6D) edge (C6U) (C7D) edge (C7U) (C8D) edge (C8U) ;
	\end{tikzpicture} \\
\hhline{~~} \\& 
...
\begin{align*}
I^u_{1}&=\langle 
u^{14}+u^{13}-3 u^{12}-4 u^{11}+4 u^{10}+7 u^9- u^8-6 u^7-2 u^6+2 u^5+2 u^4+u+1\rangle \\
\\
\end{align*}
...
\centering \section*{I. $I^u_{1}= \langle u^{14}+u^{13}-3 u^{12}-4 u^{11}+4 u^{10}+7 u^9- u^8-6 u^7-2 u^6+2 u^5+2 u^4+u+1 \rangle$}
